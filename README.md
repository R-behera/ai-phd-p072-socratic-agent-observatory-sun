...
This repo has its own runnable prototype method: **SunConstraintNlpRouteEngine**.
...
The method ranks the seed cases using a professor-aligned `science` decision rule. See `docs/unique_algorithm.md` for the mechanism and honest limitations.
