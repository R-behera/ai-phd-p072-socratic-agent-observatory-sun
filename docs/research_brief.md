...
Socratic Agent Observatory: NLP for Sun-Aligned Research

## Motivation

This project targets the intersection of **NLP, biomedical NLP, question answering, LLMs** and PhD-level research readiness. The goal is to produce a publishable-style artifact with a clear claim, reproducible experiments, and an honest account of failures.
...
2. Add one measurable method or evaluation contribution tied to Huan Sun's research area.
...
Advisor-specific slice: **NLP, biomedical NLP, question answering, LLMs**.
